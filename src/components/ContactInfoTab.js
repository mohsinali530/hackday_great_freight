...
const ContactInfoTab = () => {
    ...
    const contactInfoData = [
        {
            name: 'Abhijeet Sethi',
            email: 'raxitpatel553@gmail.com',
            mobileNo: '+91-2878647888'
        },
        {
            name: 'Pankaj Sethi',
            email: 'PS@goldee.com',
            mobileNo: '+91-8320595618',
        },
        {
            name: 'Abhijeet Sethi',
            email: 'abhijeet.s@goldee.com',
            mobileNo: '+91-2878647888'
        },
        {
            name: 'Pankaj Sethi',
            email: 'PS@goldee.com',
            mobileNo: '+91-2878647938',
        }
    ]
    ...
    const handleMobilePress = (mobileNo) => {
        Linking.openURL(`sms:${mobileNo}`);
    };
            ...
            <View style={styles.contactCardParent}>
                {
                    contactInfoData.map((contact, index) => (
                        <View style={[index != 0 && styles.contactCard1, styles.contactCardBorder]}>
                            ...
                            <View style={styles.frameContainer}>
                                ...
                                <View style={styles.defaultBoldParent}>
                                    ...
                                    <View style={styles.defaultBold1FlexBox}>
                                        <TouchableOpacity onPress={() => handleMobilePress(contact.mobileNo)}>
                                            <Text style={[styles.defaultBold2, styles.defaultTypo]}>
                                                {contact.mobileNo}
                                            </Text>
                                        </TouchableOpacity>
